...
export const metadata: Metadata = {
  title: "Managing Difficult Legal Clients & Fee Defaults",
  description:
    "Learn how to manage difficult clients, structure retainer agreements, handle fee defaults, and ethically terminate legal representation under BCI rules in India.",
  alternates: {
    canonical: "https://www.amaconnect.in/managing-difficult-legal-clients",
  },
  openGraph: {
    title: "Managing Difficult Legal Clients & Fee Defaults",
    description:
      "Learn how to manage difficult clients, structure retainer agreements, handle fee defaults, and ethically terminate legal representation under BCI rules in India.",
    url: "https://www.amaconnect.in/managing-difficult-legal-clients",
