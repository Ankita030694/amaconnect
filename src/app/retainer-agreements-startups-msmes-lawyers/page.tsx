...
export default function RetainerAgreementsPage() {
  ...
  const metadata = {
    title: "Retainer Agreements for Startups & MSMEs | Pricing & Drafts",
    description: "A complete guide for advocates on structuring monthly retainers for startups and MSMEs in India. Learn fee pricing and scopes of work.",
  };
