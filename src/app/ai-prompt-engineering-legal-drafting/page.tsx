...
export const metadata: Metadata = {
  title: "AI Prompt Engineering for Legal Drafting in India",
  description:
    "Learn how Indian lawyers use ChatGPT and Gemini for legal drafting, prompt engineering, document translation, and secure AI legal research.",
  alternates: {
    canonical: "https://www.amaconnect.in/ai-prompt-engineering-legal-drafting",
  },
  openGraph: {
    title: "AI Prompt Engineering for Legal Drafting in India",
    description:
      "Learn how Indian lawyers use ChatGPT and Gemini for legal drafting, prompt engineering, document translation, and secure AI legal research.",
    url: "https://www.amaconnect.in/ai-prompt-engineering-legal-drafting",
