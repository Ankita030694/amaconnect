...
export default function TransitionPage() {
  ...
  const metadata = {
    title: "Transition Litigation to Corporate Law Guide | AMAConnect",
    description: "Learn how to transition between litigation and corporate law firms in India. Discover resume tips, skill mapping, and transition checklists.",
  };
