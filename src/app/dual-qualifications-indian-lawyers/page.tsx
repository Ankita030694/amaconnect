...
export const metadata: Metadata = {
  title: "Dual Qualifications for Indian Lawyers: Solicitor & LLM",
  description:
    "Learn how Indian lawyers qualify in foreign jurisdictions. Study NCA Canada, SQE UK, and California/NY Bar exams pathways.",
  alternates: {
    canonical: "https://www.amaconnect.in/dual-qualifications-indian-lawyers",
  },
  openGraph: {
    title: "Dual Qualifications for Indian Lawyers: Solicitor & LLM",
    description:
      "Learn how Indian lawyers qualify in foreign jurisdictions. Study NCA Canada, SQE UK, and California/NY Bar exams pathways.",
    url: "https://www.amaconnect.in/dual-qualifications-indian-lawyers",
