...
export const metadata: Metadata = {
  title: "Continuing Legal Education & Skills for Indian Lawyers",
  description:
    "Explore continuing legal education and skill development certifications for Indian lawyers. Learn about cyber, IP, and arbitration training.",
  alternates: {
    canonical: "https://www.amaconnect.in/continuing-legal-education-skills-lawyers",
  },
  openGraph: {
    title: "Continuing Legal Education & Skills for Indian Lawyers",
    description:
      "Explore continuing legal education and skill development certifications for Indian lawyers. Learn about cyber, IP, and arbitration training.",
    url: "https://www.amaconnect.in/continuing-legal-education-skills-lawyers",
