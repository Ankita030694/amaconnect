...
export const metadata: Metadata = {
  title: "Drafting Supreme Court SLP (Article 136) Guide",
  description:
    "A highly practical guide on the anatomy of a Special Leave Petition under Article 136, including paper book formatting, the synopsis, and the List of Dates.",
  alternates: {
    canonical: "https://www.amaconnect.in/drafting-supreme-court-slp-article-136-guide",
  },
  openGraph: {
    title: "Drafting Supreme Court SLP (Article 136) Guide",
    description:
      "A highly practical guide on the anatomy of a Special Leave Petition under Article 136, including paper book formatting, the synopsis, and the List of Dates.",
    url: "https://www.amaconnect.in/drafting-supreme-court-slp-article-136-guide",
