...
export default function ProBonoGrowthPage() {
  ...
  const metadata = {
    title: "How Pro Bono Grows Your Paid Law Practice | AMAConnect",
    description: "Learn how taking pro bono cases can build your legal career, secure paid commercial referrals, and rapidly improve trial skills as an advocate in India.",
  };
