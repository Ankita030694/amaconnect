...
export default function LegalTechSoftwarePage() {
  ...
  const metadata = {
    title: "Essential Legal Tech Stack & Software for Indian Lawyers",
    description: "A comprehensive guide on adopting practice management software, document automation, secure cloud storage, and accounting tools to modernize a law chamber.",
  };
