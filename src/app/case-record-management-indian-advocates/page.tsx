...
export const metadata: Metadata = {
  title: "Case Record & Document Management for Advocates",
  description:
    "Learn how to organize case records and trial files. Discover physical folder indexing, digital backup strategies, and database tracking for chambers.",
  alternates: {
    canonical: "https://www.amaconnect.in/case-record-management-indian-advocates",
  },
  openGraph: {
    title: "Case Record & Document Management for Advocates",
    description:
      "Learn how to organize case records and trial files. Discover physical folder indexing, digital backup strategies, and database tracking for chambers.",
    url: "https://www.amaconnect.in/case-record-management-indian-advocates",
