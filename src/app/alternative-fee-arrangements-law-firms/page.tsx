...
export default function AlternativeFeePage() {
  ...
  const metadata = {
    title: "Alternative Fee Arrangements for Law Firms | AMAConnect",
    description: "Learn how Indian law firms transition from hourly billing to fixed-fee, value-based, and retainer models. Discover pricing strategies and client management.",
  };
