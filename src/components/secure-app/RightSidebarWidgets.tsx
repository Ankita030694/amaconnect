  ...
  return (
    <div className="flex flex-col gap-6 font-sans">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col">
        <h3 className="text-xl font-bold text-[#2D2219] mb-4 leading-tight">
          Urgent Legal Need in UP?
        </h3>
        ...
        <Link 
          href="/contact" 
          className="w-full bg-[#1A1A1A] text-white text-center font-bold py-3.5 rounded-xl hover:bg-black transition-colors mb-3"
        >
          Contact Our Advocates
        </Link>
        <Link 
          href="/contact"
          className="w-full bg-white border border-gray-200 text-[#1A1A1A] text-center font-bold py-3.5 rounded-xl hover:bg-gray-50 transition-colors"
        >
          Request a Callback
        </Link>
      </div>

      {/* Widget 2: App Stores (Independent card exactly similar to Cheque Bounce sidebar) */}
