...
export default function VehicleTheftHero() {
  return (
    <section className="relative w-full bg-[#000000] text-white font-sans py-10 sm:py-13 flex flex-col justify-center items-center text-center px-4">
      <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center">
        <span className="text-[#D4AF37] text-xs sm:text-sm font-bold uppercase tracking-widest bg-white/5 border border-[#D4AF37]/20 rounded-full px-4 py-1.5 mb-6">
          Motor Insurance &amp; Police Procedures in India
        </span>
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight mb-6">
          Vehicle Theft <span className="text-[#D4AF37]">Insurance Claim Guide</span>
        </h1>
        ...
        <p className="text-gray-300 font-medium text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed mb-8 max-w-3xl text-justify sm:text-center">
          Discovering that your vehicle has been stolen is distressing. To successfully secure a payout from your motor insurance provider, you must strictly follow a defined legal process, file a police FIR, submit RTO notifications, and obtain an official judicial untraced report.
        </p>
