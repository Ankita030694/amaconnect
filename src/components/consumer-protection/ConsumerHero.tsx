    ...
    <section className="relative w-full bg-black text-white font-sans py-10 sm:py-13 flex flex-col justify-center items-center text-center px-4">
      <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight mb-6">
          Consumer Protection &amp; <span className="text-[#D4AF37]">E-Commerce Rules Guide</span>
        </h1>
        ...
        <p className="text-gray-300 font-medium text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed mb-8 max-w-3xl text-justify sm:text-center">
          Approximately 85 percent of consumers in India abandon claims for defective goods due to a lack of awareness about the online e-Daakhil filing system or pecuniary jurisdiction rules under the Consumer Protection Act, 2019. Understanding unfair trade practices, misleading advertisements, and step-by-step consumer court procedures is critical to securing refunds and compensation.
        </p>
