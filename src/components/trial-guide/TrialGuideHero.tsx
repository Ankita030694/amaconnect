...
export default function TrialGuideHero() {
  return (
    <section className="relative w-full bg-black text-white font-sans py-12 sm:py-16 flex flex-col justify-center items-center text-center px-4">
      ...
      <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-snug tracking-tight mb-4">
          How to Prepare for Your First Trial: <span className="text-[#D4AF37]">Advice from Seasoned Advocates</span>
        </h1>

        <p className="text-gray-300 font-medium text-base sm:text-lg lg:text-xl leading-relaxed mb-8 max-w-3xl">
          A definitive handbook for junior lawyers and law students. Gain insights on courtroom strategy, procedural readiness, cross-examination, and etiquette from veteran litigators.
        </p>
        ...
        >
          Join Junior Advocate Community
        </Link>
