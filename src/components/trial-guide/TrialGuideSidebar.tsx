...
export default function TrialGuideSidebar() {
  return (
    <div className="flex flex-col gap-4 font-sans">
      ...
      {/* Widget 3: Mentorship Statistics */}
      <div className="bg-[#1A1410] rounded-3xl p-4 sm:p-5 text-white shadow-lg flex flex-col">
        <h3 className="text-base font-bold mb-3 border-b border-white/10 pb-2 tracking-tight">
          Mentorship Impact
        </h3>
        <div className="space-y-3">
          <div>
            <p className="text-[9px] text-gray-400 mb-0.5 uppercase tracking-wider">Active Senior Mentors</p>
            <p className="text-base font-extrabold text-[#D4AF37]">420+</p>
          </div>
          <div>
            <p className="text-[9px] text-gray-400 mb-0.5 uppercase tracking-wider">Mentorship Hours</p>
            <p className="text-base font-extrabold text-white">8,900+</p>
          </div>
          <div>
            <p className="text-[9px] text-gray-400 mb-0.5 uppercase tracking-wider">Discussion Forums</p>
            <p className="text-base font-extrabold text-white">24/7 Peer Q&amp;A</p>
          </div>
        </div>
      </div>
