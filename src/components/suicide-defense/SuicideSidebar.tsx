...
export default function SuicideSidebar() {
  return (
    <div className="flex flex-col gap-4 font-sans">
      ...
      <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-sm border border-gray-100 flex flex-col">
        ...
        <h3 className="text-lg font-bold text-[#2D2219] mb-2 leading-tight">
          Need Private Legal Advice?
        </h3>
        <p className="text-gray-600 text-xs mb-4 leading-relaxed text-justify">
          Falsely implicated under Section 306 IPC or named in a note? Connect with a criminal defense attorney privately on AMAConnect.
        </p>
        <Link 
      ...
      {/* Widget 2: App Download */}
      <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-sm border border-gray-100 flex flex-col">
        <h3 className="text-lg font-bold text-[#2D2219] mb-1.5 leading-tight">
          Download AMAConnect App
        </h3>
        <p className="text-gray-600 text-xs mb-4 leading-relaxed text-justify">
          Access legal consultation, securely upload files, and get real-time assistance on your mobile phone.
        </p>
