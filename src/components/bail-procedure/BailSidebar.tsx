...
export default function BailSidebar() {
  return (
    <div className="flex flex-col gap-6 sticky top-32 font-sans">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col">
        ...
        <h3 className="text-xl font-bold text-[#2D2219] mb-3 leading-tight">
          Facing a Bail or Arrest Emergency?
        </h3>
        <p className="text-gray-600 text-xs mb-6 leading-relaxed">
          Ask our experienced panel of criminal defense advocates your questions regarding police custody limits, anticipatory bail filing, and rights protection.
        </p>
        <Link 
          href="/ask-me-anything"
          className="w-full bg-[#1A1A1A] text-white text-center font-bold py-3.5 rounded-xl hover:bg-black transition-colors text-xs hover:scale-[1.02] active:scale-[0.98] transition-all"
        >
          Ask an Advocate Now
        </Link>
      </div>
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col">
        ...
        <p className="text-gray-600 text-xs mb-6 leading-relaxed">
          Access legal consultation, securely upload case documents and bail logs, and get real-time assistance on your mobile phone.
        </p>
