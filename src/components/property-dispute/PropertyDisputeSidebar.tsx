...
export default function PropertyDisputeSidebar() {
  return (
    <div className="flex flex-col gap-4 font-sans">
      ...
      {/* Widget 3: Essential Legal Resources */}
      <div className="bg-[#1A1410] rounded-3xl p-4 sm:p-5 text-white shadow-lg flex flex-col">
        ...
        <div className="space-y-3">
          <div>
            <p className="text-[9px] text-gray-400 mb-1 uppercase tracking-wider">Ready to File?</p>
            <Link 
              href="/contact" 
              className="text-xs font-bold text-[#D4AF37] hover:underline"
            >
              Request Court Drafts
            </Link>
          </div>
          <div>
            <p className="text-[9px] text-gray-400 mb-1 uppercase tracking-wider">Real Case Results</p>
            <Link 
          ...
          <div>
            <p className="text-[9px] text-gray-400 mb-1 uppercase tracking-wider">Helpline Support</p>
