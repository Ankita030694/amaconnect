...
export default function StartupGuideSidebar() {
  return (
    <div className="flex flex-col gap-4 font-sans">
      ...
      {/* Widget 3: Legal Drafts & Templates (points to /drafts) */}
      <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-sm border border-gray-100 flex flex-col">
        <h3 className="text-base font-bold text-[#2D2219] mb-2 leading-tight">
          Startup Legal Drafts
        </h3>
        <p className="text-gray-600 text-xs mb-4 leading-relaxed font-medium">
        ...
        <Link 
          href="/contact"
          className="text-[#D4AF37] text-center font-bold py-2 border border-[#D4AF37]/30 rounded-xl hover:bg-[#D4AF37]/5 transition-colors text-xs"
        >
