    ...
    <div className="flex flex-col gap-6 sticky top-32 font-sans">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col">
        ...
        <h3 className="text-xl font-bold text-[#2D2219] mb-3 leading-tight">
          Facing a Rent or Eviction Dispute?
        </h3>
        <p className="text-gray-600 text-xs mb-6 leading-relaxed">
          Ask a landlord-tenant legal expert on AMAConnect and get verified guidance on security deposit recovery, illegal eviction notice defense, and Rent Authority filings.
        </p>
        <Link 
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col">
        ...
        <p className="text-gray-600 text-xs mb-6 leading-relaxed">
          Access legal consultation, securely upload lease deeds and rent bills, and get real-time assistance on your mobile phone.
        </p>
