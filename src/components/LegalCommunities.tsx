  ...
  const cards = [
    {
      ...
      icon: "trademark",
      bgImage: "/bg_ipr_gold_1786014740318.png"
    },
    {
      id: 3,
      isFirst: false,
      ...
      icon: "property",
      bgImage: "/bg_property_gold_1786014857358.png"
    },
    {
      id: 4,
      isFirst: false,
      ...
      icon: "drafting",
      bgImage: "/bg_drafting_gold_1786014895403.png"
    },
    {
      id: 5,
      isFirst: false,
      ...
      icon: "loan",
      bgImage: "/bg_loan_gold_1786014928135.png"
    },
    {
      id: 2,
      isFirst: false,
      ...
      icon: "corporate",
      bgImage: "/bg_corporate_gold_1786014937955.png"
    },
    {
      id: 6,
      isFirst: false,
      ...
      link: "#",
      icon: "upcoming",
      bgImage: "/bg_upcoming_gold_1786014953006.png"
    }
  ];
        ...
        {cards.length > 0 ? (
          <>
            ...
            {cards.map((card, index) => (
              <div 
                key={card.id} 
                className={`rounded-[16px] p-4 sm:p-5 flex-col h-full shadow-2xl hover:translate-y-[-2px] hover:shadow-[0_15px_30px_rgba(0,0,0,0.6)] transition-all duration-300 relative overflow-hidden group border border-[#2D2A26] ${!showAll && index >= 3 ? 'hidden md:flex' : 'flex'}`}
                style={{
                  backgroundImage: `linear-gradient(to right, rgba(15, 15, 15, 0.85) 10%, rgba(15, 15, 15, 0.1) 85%), linear-gradient(to top, rgba(15, 15, 15, 0.9) 0%, transparent 50%), url('${card.bgImage}')`,
              ...
              >
                ...
                <div className={`flex flex-col h-full z-10 relative ${card.isComingSoon ? "filter blur-[4px] select-none pointer-events-none transition-all duration-300" : ""}`}>
                  ...
                  <div className="flex justify-start mb-3">
                    <div className="w-10 h-10 rounded-full flex items-center justify-center bg-[#1A1A1A] border border-[#D4AF37]/30 text-[#D4AF37] shadow-[0_0_10px_rgba(212,175,55,0.15)]">
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex -space-x-2">
                          <img src="/hero_portrait_1.png" alt="Member" className="w-6 h-6 rounded-full object-cover border border-[#0F0F0F]" />
                          <img src="/hero_portrait_2.png" alt="Member" className="w-6 h-6 rounded-full object-cover border border-[#0F0F0F]" />
                          <img src="/indian_man.webp" alt="Member" className="w-6 h-6 rounded-full object-cover border border-[#0F0F0F]" />
                        </div>
                    ...
                    <a 
                      ...
                      className="w-full bg-white hover:bg-gray-100 text-[#1A1508] text-center font-bold py-2.5 px-4 rounded-[10px] text-[14px] transition-all duration-300 shadow-[0_2px_10px_rgba(255,255,255,0.1)] hover:shadow-[0_4px_15px_rgba(255,255,255,0.2)] flex items-center justify-center gap-1.5"
                    >
                      Join the Community
                ...
                {/* Coming Soon Overlay */}
                {card.isComingSoon && (
                  <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-[#0F0F0F]/70 backdrop-blur-[2px] p-6 text-center transition-all duration-300">
          ...
          {!showAll && cards.length > 3 && (
            <div className="mt-8 flex justify-center md:hidden">
              <button 
                ...
                className="bg-transparent border border-[#2D2219] text-[#2D2219] font-extrabold text-[13px] tracking-wider px-8 py-3 rounded-full uppercase transition-all duration-300 hover:bg-[#2D2219] hover:text-white"
              >
