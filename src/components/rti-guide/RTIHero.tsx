...
export default function RTIHero() {
  return (
    <section className="relative w-full bg-[#000000] text-white font-sans py-10 sm:py-13 flex flex-col justify-center items-center text-center px-4">
      <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight mb-6">
          Right to Information (RTI) <span className="text-[#D4AF37]">Filing Guide</span>
        </h1>
        ...
        <p className="text-gray-300 font-medium text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed mb-8 max-w-3xl text-justify sm:text-center">
          In India, transparency and accountability in public administration are guaranteed by law. The Right to Information Act, 2005, empowers citizens to question public authorities, request official records, and inspect government works. Understanding the legal procedure, drafting format, and appeals process is essential to successfully secure the information you need from public institutions.
        </p>
