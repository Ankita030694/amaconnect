...
export default function RTISidebar() {
  return (
    <div className="flex flex-col gap-6 sticky top-32 font-sans">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col">
        ...
        <h3 className="text-xl font-bold text-[#2D2219] mb-3 leading-tight">
          Draft a Secure RTI Query
        </h3>
        <p className="text-gray-600 text-xs mb-6 leading-relaxed">
          Need help drafting a water-tight RTI query or filing an appeal? Let a legal expert on AMAConnect review your application.
        </p>
        <Link 
      ...
      <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-sm border border-gray-100 flex flex-col">
        ...
        <p className="text-gray-600 text-xs mb-6 leading-relaxed px-1">
          Access legal advice, track your application submissions, and consult with experienced lawyers directly from your mobile device.
        </p>
