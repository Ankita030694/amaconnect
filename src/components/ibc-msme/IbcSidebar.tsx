...
export default function IbcSidebar() {
  return (
    <div className="flex flex-col gap-6 sticky top-32 font-sans">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col">
        ...
        <h3 className="text-xl font-bold text-[#2D2219] mb-3 leading-tight">
          Facing Delayed Payments?
        </h3>
        <p className="text-gray-600 text-xs mb-6 leading-relaxed text-justify">
          Consult an insolvency expert on AMAConnect. Get verified advice on serving demand notices and recovering outstanding dues under the IBC Act.
        </p>
        <Link 
          href="/ask-me-anything"
          className="w-full bg-[#1A1A1A] text-white hover:bg-black text-center font-bold py-3.5 rounded-xl transition-all shadow-md hover:scale-[1.02] text-sm"
        >
          Ask an IBC Lawyer
        </Link>
      </div>
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col">
        ...
        <p className="text-gray-600 text-xs mb-6 leading-relaxed">
          Access legal consultation, securely upload MSME invoices and statements, and get real-time assistance on your mobile phone.
        </p>
